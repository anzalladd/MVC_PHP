	...
	<div class="app flex">
		...
		<div class="main-admin">
			...
			<div class="content-admin container">
				<h2>Form User</h2>
				<form action="<?php echo BASEURL . '/post/update' ?>" method="post" style="margin-top: 3rem" enctype="multipart/form-data" >
					<input type="hidden" name="id" value="<?php echo $data['table']['id']?>">
					<h3>Title</h3>
					<input type="text" name="title" value="<?php echo $data['table']['title']?>">
					<h3>Desciption</h3>
					<textarea name="description" style="width:100%" rows="20">
						<?php echo $data['table']['description']?>
					</textarea>
					<h3>Image</h3>
